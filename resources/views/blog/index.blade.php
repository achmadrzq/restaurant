...
<head>
    ...
    <body style="background: lightgray">
        ...
        <div class="card-body">
        <a href="{{ route('blog.create') }}" class="btn btn-sm btn-success mb-3">TAMBAH POST</a>
        ...
        asset('/storage/blog/'.$post->image) }}" class="rounded" style="width:
        150px">
...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <div>
                 <p style="color:white; margin-top:15px; margin-left:20px;">Hii, {{ Auth::user()->name }}</p>
            </div>
            <!-- Navbar-->
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <a href="{{ route('blog.create') }}" class="btn btn-sm btn-success mb-1">TAMBAH POST</a>
                            </div>
                            <div class="card-body">
                            <table class="table table-bordered">
                                <thead>
